...
ros::init(argc, argv, "scan_filter_pepper");
  ...
  input_scan_sub = n1.subscribe("/pepper_robot/naoqi_driver/laser", 10, input_scan_sub_callback);
  filtered_scan_pub = n2.advertise<sensor_msgs::LaserScan>("/pepper_scan_costmap", 50);
